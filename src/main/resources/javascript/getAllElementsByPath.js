	...
	for (pseudo of pseudoElements) {
		try {
			...
			if (Object.keys(extractedAttributes).length > 2) {
				allElements[path] = extractedAttributes;
			}
		} catch (err) {}
	}
}
